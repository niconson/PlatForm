...
|2.4.27|Фильтр футпринтов по расстоянию между пинами, альтернативные функции пина на схеме, область запрета в футпринте, требование проверки DRC перед генерацией герберов, панелизация с репперными знаками на стадии формирования герберов, фрезерный контур для панелизации плат со сложным контуром, симметризация мультизаготовки для оптимизации производства, генерация CSV-report для панелизированных плат, интерактивный вид печатной в схематоре (скрипт), ноуды на концах полилинии(F9), возм.сепарированной печати в один файл, оптимизация, мелкие доработки|планируется 10.10.2025|
