...
Последняя версия 2.4.хх, представленная на этом сайте, включает в себя внутри редактора плат облегченный генератор простых 3Д-объектов для среды моделирования OpenSCAD, который теперь позволяет просматривать печатную плату в 3D.
...
|2.4.24(текущая)|Исправлена ошибка работы с инфобоксом. Мелкие улучшения|12.06.2025|
