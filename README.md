...
| 2.4.29(текущая) | Автоматическое ыравнивание при перетаскивании группы в схемном редакторе по узлам проводов и компонентов на схеме. Шаг выбранной сетки в данном случае является областью действия магнита  | ХХ.ХХ.2026 |
