...
**_Совет: Рекомендуется полностью исключить русские буквы и спецсимволы из пути к папке проектов Схематора, т.к. иначе OpenSCAD может не открывать 3D-модель._**
